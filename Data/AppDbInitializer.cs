                ...
                if (!context.Producers.Any())
                {
                    context.Producers.AddRange(new List<Producer>()
                    {
                        ...
                        new Producer ()
                        {
                            ...
                            ProfilePictureURL = "http://dotnethow.net/images/producer-3.jpeg",
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>() {
                      new Movie ()
                      {
                        ...
                        CinemaId=1,
                        ProducerId=3,
                        MovieCatagory=Enums.MovieCatagory.Cartoon
                      },
                     new Movie ()
                      {
                        Name="Cold Soles",
                     ...
                     new Movie ()
                      {
                        ...
                        CinemaId=4,
                        ProducerId=4,
                        MovieCatagory=Enums.MovieCatagory.Horror
                      },
                     new Movie ()
                      {
                        Name="Race",
                        ...
                        CinemaId=1,
                        ProducerId=2,
                        MovieCatagory=Enums.MovieCatagory.Documentary
                      },
                     new Movie ()
                      {
                        ...
                        CinemaId=1,
                        ProducerId=1,
                        MovieCatagory=Enums.MovieCatagory.Action
                      },
